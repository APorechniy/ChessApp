...
import { QualitiesService } from "../../src/services";
...
describe("Quality Service", () => {
    ...
    beforeAll(async () => {
        ...
        const qualitiesRepository = new QualitiesRepository(dataSource);
        qualitiesService = new QualitiesService(qualitiesRepository);
    })
    ...
    test("Get quality by ID", async () => {
        ...
        const qualityById = await qualitiesService.getQualityById(qualityId)
    ...
    test("Get 'attendance' qualities", async () => {
        ...
        const qualities = await qualitiesService.getQualitiesListByLabelFor("attendance")
    ...
    test("Get 'tasks' qualities", async () => {
        ...
        const qualities = await qualitiesService.getQualitiesListByLabelFor("tasks")
