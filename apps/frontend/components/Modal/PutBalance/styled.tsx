...
export const PutBalanceModal = styled.div`
...
export const UKassaBlock = styled.div`
    width: 100%;
    height: 100%;
...
export const PutBalanceForm = styled.form`
    width: 100%;
    max-width: 100%;
    height: auto;
...
export const PutBalanceFormTitle = styled.h3`
    text-align: left;
    margin: 0;
    margin-left: 1rem;
