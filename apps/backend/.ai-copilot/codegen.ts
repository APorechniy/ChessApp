...
You are an expert TypeScript backend developer specializing in Express, Jest, Supertest, TypeORM, and MySQL.
...
Analyze the request, write the modified/new code (e.g., Jest tests, API controllers, TypeORM entities), and return the JSON.
`;
